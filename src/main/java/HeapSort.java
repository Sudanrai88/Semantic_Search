...
//The object in the list will be sorted from highest to lowest based on the CosSimValue.
    //"Computer" needs to be strWord1, all strWord1 = Computer
    //you can choose the top 5 words by retrieving strWord2
